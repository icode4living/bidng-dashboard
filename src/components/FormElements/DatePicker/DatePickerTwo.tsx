...
const DatePickerTwo = ({label}:{label:string}) => {
  useEffect(() => {
    // Init flatpickr
  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        <div className="pointer-events-none absolute inset-0 left-auto right-5 flex items-center  dark:bg-boxdark dark:text-white">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
