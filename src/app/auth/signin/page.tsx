...
const apiClient = new ApiClient('/api')
  async function handleLogin(event: React.FormEvent<HTMLFormElement>) {
    ...
    setLoading(true)
    try{
    const status = await apiClient.postRequest('/login',{
      email:email,
      password:password})
      if(status){
        setLoading(false)
...
<>
  {loading  ?<Loader/> :  <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
