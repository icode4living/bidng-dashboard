...
const [title, setTitle] = useState<string>("");
  ...
  const categories = [
   ...
   // if(title.)
    try {
        const variables = {
          title: title,//"BYD Hybrid",
          description: description,// "2024_AutoChinaBeijing_Jetour_X70_Plus-3 - Paul Tan's Automotive",
          startPrice:parseFloat(startPrice) ,//3450000.0,
          category: category,//"cars",
          startDate: startDate,//"1737512916635",
          expiresAt: expireAtDate,//"1737512916635",
          image: image,//"https://paultan.org/image/2024/04/2024_AutoChinaBeijing_Jetour_X70_Plus-3-850x567.jpg",
        ...
        location.replace(`/dashboard/auction/${data?.createAuction.id}`);

        console.log("Auction Created:", data?.createAuction);
      } catch (error) {
        setIsLoading(false);
        alert("Error uploading Auction")
            ...
            <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
              ...
              <div className="p-7">
                <form onSubmit={(e)=>{
                  ...
                  <div className="mb-5.5 flex flex-col gap-5.5 sm:flex-row">
                    <DatePickerOne label="Start Date" onChange={setStartDate} />
                    <DatePickerOne label="End Date" onChange={setExpireAtDate}/>
